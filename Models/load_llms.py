...
if __name__ == "__main__":
    ...
    # path="/data/shared/mistral-7b-v03/Mistral-7B-v0.3_shard_size_1GB"
    # path = "/data/shared/olmo/OLMo-7B_shard_size_2GB"
    path = "/data/shared/llama3-8b/Meta-Llama-3-8B_shard_size_1GB"
    llm = HuggingFaceLLM(path, device)
